...
public class LauncherActivity extends ListActivity {
	...
	public static final String[] options = { "ListView", "ExpandableListView", "GridView", "ScrollView",
			"Horizontal ScrollView", "ViewPager", "ListView in ViewPager","PullToRefreshRecyclerHorizontalActivity", "PullToRefreshRecyclerVerticalActivity" };
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		switch (position) {
			...
			case 6:
				...
				break;
			case 7:
				intent = new Intent(this, PullToRefreshRecyclerHorizontalActivity.class);
				break;
			case 8:
				intent = new Intent(this, PullToRefreshRecyclerVerticalActivity.class);
				break;
		}
